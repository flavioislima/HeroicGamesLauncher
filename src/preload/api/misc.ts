...
export const getEALoginData = makeHandlerInvoker('getEALoginData')
export const authEA = makeHandlerInvoker('authEA')
export const logoutEA = makeHandlerInvoker('logoutEA')
export const getEAUserInfo = makeHandlerInvoker('getEAUserInfo')
export const getEAVersion = makeHandlerInvoker('getEAVersion')
