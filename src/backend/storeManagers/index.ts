...
import * as HumbleGameManager from 'backend/storeManagers/humble/games'
...
import * as HumbleLibraryManager from 'backend/storeManagers/humble/library'
...
export async function initStoreManagers() {
  ...
  await HumbleLibraryManager.initHumbleLibraryManager()
